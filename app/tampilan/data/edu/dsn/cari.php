					...
					<center>
						<form action="<?php echo BASIS_URL; ?>/data/dsn/cari" method="post">
							<div class="container">
								<div class="input-group">
									<input type="text" id="cari" name="cari" class="form-control" placeholder="NIPD atau Nama Dosen" value="<?php echo $data['hasil']['kueri']; ?>">
						...
						<table class="table table-responsive table-striped table-hover mt-2">
							...
							<tbody>
								...
								<?php else: ?>
									<?php foreach ($data['hasil']['hasil'] as $dsn): ?>
										<tr>
											<td><?php echo $no++; ?></td>
											...
											<td>
												<div class="btn-group">
													<a href="<?php echo BASIS_URL . '/data/dsn/detail/' . $dsn['dsn_id']; ?>" class="btn btn-primary">Detail</a>
													<a href="<?php echo BASIS_URL . '/data/dsn/edit/' . $dsn['dsn_id']; ?>" class="btn btn-warning">Edit</a>
													<a href="<?php echo BASIS_URL . '/data/dsn/hapus/' . $dsn['dsn_id']; ?>" class="btn btn-danger">Hapus</a>
												</div>
											</td>
										</tr>
									<?php endforeach ?>
